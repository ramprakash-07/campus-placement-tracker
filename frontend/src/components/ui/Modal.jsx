...
export default function Modal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-0 sm:p-4">
      ...
      <div
        className={`relative w-full h-full sm:h-auto sm:${maxWidth} bg-white dark:bg-gray-900 sm:rounded-2xl shadow-2xl sm:ring-1 sm:ring-gray-200/60 dark:sm:ring-gray-700/60 animate-slideUp sm:max-h-[90vh] overflow-y-auto`}
      >
        {/* Header */}
        <div className="flex items-center justify-between px-4 sm:px-6 py-4 border-b border-gray-100 dark:border-gray-800 sticky top-0 bg-white dark:bg-gray-900 sm:rounded-t-2xl z-10">
          <div className="flex items-center gap-2.5">
            {Icon && (
              <div className="flex items-center justify-center w-9 h-9 rounded-xl bg-primary-50 dark:bg-primary-900/30">
